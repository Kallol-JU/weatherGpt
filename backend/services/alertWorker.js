...
// Export as a callable function instead of a background cron job
export async function triggerAlerts() {
  ...
  webPush.setVapidDetails(
    process.env.VAPID_EMAIL || "mailto:admin@weathergpt.com",
    process.env.VAPID_PUBLIC_KEY,
    process.env.VAPID_PRIVATE_KEY,
  );

  console.log("🔍 Running weather alert check via API trigger...");
  try {
    ...
    return { success: true, checkedUsers: users.length };
  } catch (error) {
